...
class Media {
  ...
  /// Текст, распознанный на фотографии — по нему ищет поиск (секция «на фото»).
  ///
  /// Пока не заполняется: у ML Kit нет модели для кириллицы (только латиница,
  /// деванагари, китайский, японский, корейский), а ради латинских надписей
  /// тянуть в дневник десять мегабайт нативной библиотеки не стоит. Поле и
  /// поиск по нему оставлены готовыми — под движок, который умеет кириллицу.
  final String? ocr;
